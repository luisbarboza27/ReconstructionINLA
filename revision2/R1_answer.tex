...
\bl{suggest the following}
We expect that as the reconstruction period increases more differences among INLA and MCMC may be observed. This is because 
 complex and high dimensional MCMC schemes will likely suffer from unfavorable convergence properties (see \cite{Rajaratnam2015} for example), then results from INLA which is trying to mimic the real posterior density of Bayesian models may yield more different results than MCMC. 
