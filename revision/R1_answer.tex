...
version are shown in Table \ref{tab:screening}.\bl{it seems you just calculate the correlation between RPs or between RP and temperature. Why it is an averaged correlation?}
\begin{table}
  \centering
