...
version are shown in Table \ref{tab:screening}.\bl{it seems you just calculate
  the correlation between RPs or between RP and temperature. Why it is an
  averaged correlation?}\lb{We have eight reduced proxies in total and I
wanted to show just a single correlation for each method, that's the reason why
