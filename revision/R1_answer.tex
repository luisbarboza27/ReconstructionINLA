...
why we consider a state-space model to represent the dynamics of the temperature
...
reconstrction, instead we measure the MSE between the smoothed reconstruction
