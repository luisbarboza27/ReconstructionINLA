...
samples within its definition. We changed the title and include the
clarification in the article as you suggested. 
...
Please see the answer above (second bullet).
...
independent random effect to model the error term in the latent equation.  
...
this figure.   
\jeg{I have the same question, actually}\bl{The posterior marginal mjst come from samples, right? the reviewer asked how many samples used to produce the density plot.}
