...
the difference. \bl{can you not solve it by thinning the posterior?}\lb{Thinning
is a possible solution, but the MCMC's computational time makes thinning challeging.}
