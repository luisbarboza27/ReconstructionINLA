...
Many studies have conducted BHMs: \cite{boli1, tingley2013_Ext,werner2012pseudoproxy,Barboza2014} are examples among others. Some of these studies have used space-state
...
The dataset is collected through 692
...
\noindent {\bf Volcanic forcing} from the Easy Volcanic Aerosol (EVA) dataset (evolv2k,
...
\noindent {\bf Solar forcing} data is computed from the SATIRE-H
  ...
  from 1940AD onwards. Hence, the data prior to 1939AD was interpolated using BSplines and after 1940AD, at annual resolution. For consistency, daily data from 1640AD to 2000AD is also BSpline-interpolated to annual resolution (Fig.~\ref{fig:forcings}, middle). 
