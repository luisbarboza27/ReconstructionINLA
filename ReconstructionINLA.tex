...
\citep{MBH98,luterbacher2004european}, regularized forms of the expectation-maximization algorithm \citep{Schneider2001,mann2005testing,mann2007robust,steig2009,JEG10a,Guillot_AOAS2015}, canonical
...
\citet[][, hereafter, "B14"]{Barboza2014} proposed a method that jointly models the variability of the
...
\citep{Jones_Holocene09}. The vast majority of records are annually-resolved, with minimal dating uncertainty. 
...
$t=1,\cdots,2000$ (Common Era). It is important to add that Models NF and WF simply assume an independent error structure. This is because B14 
