...
\jeg{You want to say something about screened vs unscreened here?}\lb{I think we
can skip that due to the 25-pages limit.}
...
reconstruction of \cite{Pollack2004} over 1600-1899 (PS04 dataset). We chose this dataset because it uses completely independent measurements of temperature, and apply to an out-of-sample validation interval, thereby providing independent information on low-frequency behavior. Note that PS04 targets centennial trends, so we compare them to smoothed versions of our reconstructions, obtained through a Butterworth low-pass filter with a 50-year cutoff and order equal to 4. We compared in this case Model WF with a single RP
...
\caption{Comparison of predictive measures. The IS and CRPS measures are
  negatively oriented (lower scores are better). and computed over 1850-1899 as
  an out-of-sample validation period.
  Furthermore, MSE is computed over 1600-1899.}
...
efficient, it could be used to extend this work to a spatiotemporal context. Another important area of application is the simultaneous inference of climate fluctuations and deposition age \citep{Sweeney:WIRES2018}.
