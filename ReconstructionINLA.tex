...
reconstruction of \citet[hereafter, PS04]{Pollack2004} over 1600-1899. We chose this dataset because it uses completely independent measurements of temperature, and covers an out-of-sample interval, thereby providing independent information on low-frequency behavior. Note that PS04 targets centennial trends, so we compare them to smoothed versions of our reconstructions, obtained through a Butterworth low-pass filter with a 50-year cutoff and order equal to 4. We compared in this case Model WF with a single RP
