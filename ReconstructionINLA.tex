...
\keywords{INLA, Hierarchical Bayesian Model, Paleoclimate Reconstruction}
\subjclass[2010]{}
\maketitle
...
Many studies have conducted BHMs: \cite{boli1, tingley1,tingley2,tingley2013_Ext,werner2012pseudoproxy,Barboza2014} among others. Some of these studies have used space-state
...
\begin{figure}
  ...
  \caption{Paleoclimate Reconstruction 1500-2000 with 95\%
    prediction bands. Best two choices per validation method. The out-of-sample validation period is
    located between the red lines.\bl{No red lines here?}}
