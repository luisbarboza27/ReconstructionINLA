...
\author[]{Wan He}
\address{Khoury College of Computer Sciences \\
...
The former validates the reconstruction precisely to an interannual scale, while the latter constrains centennial trends. Both datasets are completely independent of the PAGES 2k records or HadCRUT4 data used for calibration. 
